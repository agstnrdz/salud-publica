...
map.getView().fit([-7540160.585482, -5771388.858759, -7497981.852064, -5731854.381001], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Infraestructura de salud pública | Comodoro Rivadavia</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (208 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Visualizador interactivo de la infraestructura de salud pública de la ciudad de Comodoro Rivadavia. Datos actualizados a agosto de 2025. Fuente: Dirección General de Modernización e Investigación Territorial.';
            }
